...
export default function StickyTopNav() {
  ...
  return (
    <header className="sticky top-0 z-40">
      <div className="btn-gradient px-4" style={{ minHeight: 64 }}>
        <div className="mx-auto flex h-16 max-w-6xl items-center gap-4">
          <button
            onClick={() => setMenuOpen((o) => !o)}
            className="hidden shrink-0 items-center gap-1 rounded-full bg-white/15 px-3 py-1.5 font-body text-xs font-semibold text-white hover:bg-white/25 md:flex"
          >
          ...
          <Link to="/" className="shrink-0 leading-tight">
            <span className="font-display text-2xl font-black tracking-tight">
              ...
              <span className="text-gold">su</span>
            </span>
          </Link>
          ...
          <div ref={searchRef} className="relative flex-1">
            <input
              ...
              className="w-full rounded-full border-none bg-white px-4 py-2.5 font-body text-sm text-ink outline-none focus:ring-2 focus:ring-gold"
            />
          ...
          <div className="flex shrink-0 items-center gap-4 text-white">
            <Link
              to="/login"
              className="hidden font-body text-sm font-semibold sm:inline"
            >
