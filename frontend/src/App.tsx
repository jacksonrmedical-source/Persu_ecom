      ...
      <AllProductsProvider>
        ...
        <main className="min-h-[60vh]">
          <Routes>
            ...
            <Route path="/about" element={<StaticInfoPage title="About PERZN" body="PERZN brings you curated fashion at honest prices — dresses, shoes, and accessories picked for everyday wear, drop by drop." />} />
            <Route path="/terms" element={<StaticInfoPage title="Terms & Conditions" body="By using PERZN, you agree to our standard terms of sale, including pricing, order acceptance, and dispute resolution policies." />} />
